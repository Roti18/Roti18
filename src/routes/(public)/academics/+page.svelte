...
{#if !hasAccess}
	{#if overlayClosed}
		...
		>
			<div
				class="max-w-md w-full space-y-4 rounded-2xl p-8 shadow-2xl backdrop-blur-xl"
			>
				<div
				...
				<p class="text-xs text-[#a1a1a1] leading-relaxed">
					Course materials, assignments, and lab resources are exclusively restricted to Trunojoyo University student accounts (<span class="text-red-400 font-mono font-medium"
