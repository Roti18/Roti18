...
Outside of code, I'm into photography, music, and exploring the local food scene. I believe in learning by building and sharing what I learn along the way.`,
  ...
  socialLinks: [
    { platform: "GitHub", url: "https://github.com/roti18", icon: "github" },
    { platform: "X", url: "https://x.com/roti18", icon: "x" },
    {
      platform: "YouTube",
      url: "https://youtube.com/@roti18",
      icon: "youtube",
    },
  ],
  techStack: [
...
export const mockWritings = [
  {
    ...
    excerpt:
      "How I rebuilt my portfolio from scratch using SvelteKit and Turso.",
    content: "",
...
<p>I wanted something minimal. Typography-driven. No flashy gradients or 3D effects - just clean text on a dark background. I took heavy inspiration from <a href="https://rotilovin.com">roti Lovin's site</a>, which I think is one of the best personal sites on the web.</p>
...
<p>Authentication is handled by Better Auth with Google OAuth only. No passwords, no magic links. One click and you're in.</p>`,
  ...
  },
  {
    ...
    content: "",
    contentHtml:
      "<p>Svelte 5 runes changed everything about how I think about reactivity...</p>",
    year: 2026,
    likes: 28,
    published: true,
  ...
  },
  {
    ...
    content: "",
    contentHtml:
      "<p>Turso has been a revelation for my personal projects...</p>",
    year: 2026,
    likes: 15,
    published: true,
  ...
  },
  {
    ...
    content: "",
    contentHtml:
      "<p>GSAP is incredibly powerful, but it needs some care in SSR environments...</p>",
    year: 2026,
    likes: 33,
    published: true,
  ...
  },
  {
    ...
    content: "",
    contentHtml:
      "<p>Both photography and programming are about seeing patterns...</p>",
    year: 2025,
    likes: 19,
    published: true,
...
export const mockProjects = [
  {
    ...
    contentHtml:
      "<p>A complete rebuild of my personal portfolio using SvelteKit 5, Turso database, and GSAP animations. Minimalist design inspired by rynds.my.id</p>",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&q=80",
    repoUrl: "https://github.com/roti18/roti18",
    repoIsPublic: true,
    demoUrl: "https://rynds.my.id",
    demoIsLive: true,
    featuredOnHome: true,
    sortOrder: 0,
  },
  {
    ...
    contentHtml:
      "<p>An interactive knowledge base built as a desktop-like OS interface in the browser.</p>",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&q=80",
    repoUrl: "https://github.com/roti/brios",
    repoIsPublic: true,
    demoUrl: "https://brios.roti.dev",
    demoIsLive: true,
    featuredOnHome: true,
    sortOrder: 1,
  },
  {
    ...
    contentHtml:
      "<p>A fast, minimal CLI tool for capturing and annotating screenshots from the terminal.</p>",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=800&q=80",
    repoUrl: "https://github.com/roti/snap-cli",
    repoIsPublic: true,
    demoUrl: null,
    demoIsLive: false,
  ...
  },
  {
    ...
    contentHtml:
      "<p>A shared academic resource archive for students at Universitas Trunojoyo Madura.</p>",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&q=80",
    repoUrl: "https://github.com/roti/akademik-utm",
    repoIsPublic: false,
    demoUrl: null,
    demoIsLive: false,
    featuredOnHome: true,
  ...
  },
  {
    ...
    content: "",
    contentHtml:
      "<p>Extract dominant colors from any image and generate harmonious color palettes.</p>",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1500462918059-b1a0cb512f1d?w=800&q=80",
    repoUrl: "https://github.com/roti/color-palette",
    repoIsPublic: true,
    demoUrl: "https://palette.roti.dev",
    demoIsLive: true,
    featuredOnHome: false,
    sortOrder: 4,
  },
...
export const mockMusic = [
  ...
  },
  {
    ...
    musicUrl:
      "https://open.spotify.com/search/Blugazer%20Waking%20Still%20Beneath",
    playedAt: new Date("2026-07-19"),
  },
  {
    id: "4",
    ...
    musicUrl:
      "https://open.spotify.com/search/Brendel%20Brighter%20Than%20Yesterday",
    playedAt: new Date("2026-07-19"),
  },
  {
    id: "5",
  ...
  },
  {
    ...
    musicUrl:
      "https://open.spotify.com/search/Sound%20Quelle%20Our%20Own%20Island",
    playedAt: new Date("2026-07-18"),
  },
  {
    id: "8",
    ...
    musicUrl:
      "https://open.spotify.com/search/Isam%20Hadjih%20Through%20The%20Dark",
...
export const mockGalleryPhotos = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1515694346937-94d85e39aacf?w=800&q=80",
    ...
    courses: [
      {
        ...
        materials: [
          ...
          },
          {
            ...
            type: "materi" as const,
            contentHtml:
              "<p>Understanding variables and data types in programming...</p>",
            attachments: null,
          ...
          },
          {
            ...
            type: "tugas" as const,
            contentHtml:
              "<p>Create a simple Hello World program in three different languages...</p>",
          ...
          },
          {
            ...
            contentHtml:
              "<p>Setting up your development environment for the course...</p>",
            attachments: null,
